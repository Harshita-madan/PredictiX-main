...
function Navbar() {
  ...
  const fetchProfile = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/api/v1/users/profile" || "http://predictix-main.onrender.com/api/v1/users/profile",
        {
          credentials: "include",
        }
      );
  ...
  const logout = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/api/v1/users/logout" || "http://predictix-main.onrender.com/api/v1/users/logout",
        {
          credentials: "include",
          method: "POST",
        }
